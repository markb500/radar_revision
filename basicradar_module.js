...
function basicradar(ctx, ctx2) {
    var notesLink, slantrange, sum, pp, pw, prf, mp, ps;
    sumq = "";
    suma = "";
    sumarrbasicrad = QLimitRepeats(sumarrbasicrad, 51);   //Ensures no repeat question until at least 50% of questions shown
    ...
    switch(sum) {
        ...
        case 13:
            ...
            ctx.drawImage(basicradblklblq, 0, 0, 500, 300);
            break;
        case 14:
            notesLink = "images/20200323-RadarBk1BasicRadCIv1_5-APO.pdf#page=16";
            sumq += "With reference to the Basic Pulsed Radar Block Diagram shown, sketch the waveforms found at test points A - C.";
            ctx.drawImage(basicradblkwaveq, 0, 0, 500, 300);
            ctx2.drawImage(basicradblkwavea, 0, 0, 500, 300);
            break;
        case 15:
